...
class _WorkoutHistoryCardState extends State<WorkoutHistoryCard> {
  ...
  bool _isExpanded = false; // For expand/collapse
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...(_isExpanded 
              ? _workoutLog!.workouts 
              : _workoutLog!.workouts.take(3)
          ).map((workout) {
            return Container(
          ...
          if (_workoutLog!.workouts.length > 3)
            Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        _isExpanded 
                            ? 'Thu gọn' 
                            : 'Xem thêm ${_workoutLog!.workouts.length - 3} bài tập',
                        style: GoogleFonts.baloo2(
