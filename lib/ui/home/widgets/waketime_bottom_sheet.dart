...
class WaketimeBottomSheet extends StatefulWidget {
  ...
  final Function(String wakeTime, double actualHours, int quality, String? notes)? onSaved;
...
class _WaketimeBottomSheetState extends State<WaketimeBottomSheet> {
  ...
  void initState() {
    ...
    // Default wake date = dashboard date (simple and predictable)
    _wakeDate = widget.displayDate != null 
          ...
          Row(
            ...
            children: List.generate(5, (index) {
              return IconButton(
                ...
                icon: Icon(
                  index < _quality ? Icons.star_rounded : Icons.star_outline_rounded,
                  size: context.sp(9),
                  color: index < _quality ? const Color(0xFFFFC107) : Colors.grey.shade300,
                ),
              );
            }),
          ),
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    onPressed: _wakeTime != null && _calculatedHours != null && _wakeDate != null
                        ? () {
                            print('[DEBUG WAKETIME] Save button clicked');
                            print('[DEBUG WAKETIME] _wakeTime: $_wakeTime, _wakeDate: $_wakeDate, _quality: $_quality');
                            ...
                            final wakeTimeStr = DateFormat("yyyy-MM-dd'T'HH:mm:ss").format(wakeDateTime);
                            print('[DEBUG WAKETIME] Formatted wakeTime: $wakeTimeStr');
                            print('[DEBUG WAKETIME] Calling onSaved callback...');
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      padding:
                          EdgeInsets.symmetric(vertical: context.h(0.018)),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(context.w(0.03)),
                      ),
                    ),
