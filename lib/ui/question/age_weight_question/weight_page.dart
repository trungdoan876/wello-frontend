            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // ----- BMI DISPLAY -----
                  if (widget.height != null) BmiDisplayCard(bmiData: bmiData),
                      ...
                      onPressed: () async {
                        ...
                        if (widget.onUpdate != null) {
                          ...
                          if (widget.goal == 'LOSE_WEIGHT' ||
                            ...
                            final activityQuestion = provider
                                .getQuestionByIndex(7);
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => ActivityLevelScreen(
                                    ...
                                    userId: widget.userId,
                                    targetWeight:
                                        null, // No target weight for KEEP_FIT/MAINTAIN_WEIGHT
                                  ),
                                ),
                              );
                            }
