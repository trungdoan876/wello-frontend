...
class FoodDetailSheet extends StatefulWidget {
  ...
  final int baseCalories; // Calories per 100g (assumed based on standard food DB)
...
class _FoodDetailSheetState extends State<FoodDetailSheet> {
  ...
  Future<void> _logFood() async {
    ...
    try {
      ...
      if (summary != null && profile != null && _previewData != null) {
        final currentConsumed = summary.caloriesConsumed;
        final newCalories = _previewData!.calories;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Nutrition Details Preview
          if (_previewData != null || _isPreviewing)
            Container(
              ...
              child: _isPreviewing && _previewData == null
                  ...
                  : Row(
                      ...
                      children: [
                        _buildNutrientItem('Calories', '${_previewData?.calories ?? 0}', 'kcal', const Color(0xFFFF6B6B)),
                        _buildNutrientItem('Protein', '${_previewData?.protein.toStringAsFixed(1) ?? 0}', 'g', const Color(0xFF4ECDC4)),
                        _buildNutrientItem('Carbs', '${_previewData?.carbs.toStringAsFixed(1) ?? 0}', 'g', const Color(0xFFFFD93D)),
                        _buildNutrientItem('Fat', '${_previewData?.fat.toStringAsFixed(1) ?? 0}', 'g', const Color(0xFFFF8066)),
                      ],
                    ),
            ),
          SizedBox(height: context.h(0.01)),
